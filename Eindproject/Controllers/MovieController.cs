...
namespace Eindproject.Controllers
{
    ...
    public class MovieController : Controller
    {
        ...
        public IActionResult EditSerie(int id, int gekeken, int score)
        {
        ...
        public IActionResult EditMovie(int id, string gekeken, int score)
        {
            var x = _context.SerieOfFilms.FirstOrDefault(s => s.SerieOfFilmInLijstId == id);
            if (gekeken == "on")
            {
        ...
        /// </summary>
        private List<Tuple<ApplicationUser, Comment>> GenerateCommentsForMovie(string title)
        {
            ...
            List<Tuple<ApplicationUser, Comment>> UserToComment = new List<Tuple<ApplicationUser, Comment>>();
            ...
            foreach (var comment in CommentsOrderedByDate)
            {
                ...
                {
                    var commentUserTuple = MapUserWithComment(users, comment);
                    UserToComment.Add(commentUserTuple);
                }
