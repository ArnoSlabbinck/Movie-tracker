...
{
    public partial class _09082022 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2022, 8, 9, 19, 40, 10, 399, DateTimeKind.Local).AddTicks(1018), new DateTime(2022, 8, 9, 19, 40, 10, 392, DateTimeKind.Local).AddTicks(2484), null });

            migrationBuilder.InsertData(
                table: "Statuses",
                columns: new[] { "StatusId", "StatusDescription" },
                values: new object[] { 1, "Done" });

            migrationBuilder.InsertData(
                table: "Statuses",
                columns: new[] { "StatusId", "StatusDescription" },
                values: new object[] { 2, "Watching" });
